...
let arr1 = bubbleSort(arr: sortArr)
print("冒泡排序: \(arr1)")
...
let arr2 = selectionSort(arr: sortArr)
print("选择排序: \(arr2)")
...
let arr3 = insertionSort(arr: sortArr)
print("插入排序: \(arr3)")
...
let arr4 = mergeSort(arr: sortArr)
print("归并排序: \(arr4)")
